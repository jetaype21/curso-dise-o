...
class TeacherProfile extends Component {
  ...
  refreshTeacher = () => {
    ...
    Promise.all([getTeacher, getCourses])
      .then((response) =>
        this.setState({ teacher: response[0].data, courses: response[1].data })
      )
      .catch(() => {
  ...
  deleteCourse = (course_Id) => {
    this.coursesServices
      ...
      .catch(() => {
        ...
        this.props.handleToast(
          true,
          "Ocurrio un error al borrar curso, vuela a intentar",
          "#f8d7da"
        );
      });
  };
  ...
  deleteTeacher = () => {
    ...
    this.teachersServices
      ...
      .then(() => {
        ...
        this.props.history.push("/profile");
        this.props.handleToast(true, "Se elimino exitosamente!", "#d4edda");
      })
      .catch(() => {
        this.props.history.push("/profile");
        this.props.handleToast(
          true,
          "Ocurrio un error al borrar el perfil, vuela a intentar",
          "#f8d7da"
        );
      });
  };
            ...
            <>
              <Row>
                <Col md={{ span: 8 }} lg={{ span: 8 }}>
                  ...
                  this.props.teacherInfo._id === this.state.teacher._id ? (
                    ...
                    <h3>
                      <strong>Acerca del profesor</strong>
                    </h3>
                  )}
              ...
              <Row>
                <Col md={12}>
                  {this.props.teacherInfo &&
                  this.props.teacherInfo._id === this.state.teacher._id ? (
                    <h2 className="mt-5 mb-5">Mis cursos</h2>
                  ) : (
                    <h2 className="mt-5 mb-5">Profesores de los cursos</h2>
                  )}
                </Col>
              </Row>
              ...
              <Row>
                {this.state.courses.length > 0 ? (
                  ...
                  <Col className="cta">
                    <Row className="d-flex justify-content-between">
                      <p className="mt-2 mb-0">
                        Empecemos a enseñar,{" "}
                        <strong>{this.state.teacher.name}</strong>!crea un
                        archivo atractibo.
                      </p>
                      <Link
                        to="/profile-teacher/create-course"
                  ...
                  <Col className="cta">
                    <Row className="d-flex justify-content-between">
                      <p className="mt-2 mb-0">
                        Este profesor aún no ha creado cursos.
                      </p>
