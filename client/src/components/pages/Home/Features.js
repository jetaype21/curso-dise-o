      ...
      <Container>
        <Row className="d-flex align-items-center">
          <Col lg={6} md={12} style={{ textAlign: "left" }}>
            <h2 className="mb-3">No pierda su valioso tiempo</h2>
            <p>
              Sólo ETS EDUCA tiene todos los factores críticos para ofrecer
              resultados reales.
            </p>{" "}
            Sólo ETS EDUCA tiene todos los factores críticos para ofrecer
            resultados reales.
            <p>
              Sólo ETS EDUCA tiene todos los factores críticos para ofrecer
              resultados reales, y organizaciones sin ánimo de lucro el poder de
