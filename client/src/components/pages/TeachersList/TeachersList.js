...
class TeachersList extends Component {
  ...
  refreshTeachers = () => {
    this.teachersService
      .getTeachers()
      .then((res) =>
        this.setState({ teachers: res.data, filteredTeachers: [...res.data] })
      )
      .catch(() => {
  ...
  filterBySearch = (value) =>
    this.setState({
      filteredTeachers: [...this.state.teachers].filter((elm) =>
  ...
  sortBy = (option) => {
    ...
    switch (option) {
      case "Name-A":
        this.setState({
          filteredTeachers: filteredTeachersCopy.sort((a, b) =>
            a.name > b.name ? 1 : -1
          ),
        });
        break;
      ...
      >
        <section className="container-fluid teacher-hero">
          <div className="heading">
            <Container>
              <h1 className="mt-5">Nuestros profesores</h1>
              <p>
                Ayuda a la gente a aprender y vivir una vida sana, <br></br>y
                explora compartiendo sus conocimientos.
              </p>
              <SearchBar
