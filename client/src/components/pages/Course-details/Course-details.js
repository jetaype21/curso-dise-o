  ...
  deleteComment = (commentId) => {
    this.commentsService
      ...
      .catch(() => {
        ...
        this.props.handleToast(
          true,
          "Ocurrio un error al eliminar el comentario, vuela a intentar",
          "#f8d7da"
        );
      });
  };
          ...
          {this.state.course ? (
            <>
              <section className="header">
                <Row>
                  <Col md={{ span: 8 }}>
                    ...
                    <p>
                      <strong>Categoria:</strong> {this.state.course.category} |{" "}
                      <strong>Nivel de dificultad::</strong>{" "}
                      {this.state.course.difficultyLevel} |{" "}
                      <strong>Precio:</strong> {this.state.course.price} € |{" "}
                      <strong>Duración:</strong> {this.state.course.duration}{" "}
                      hrs.
                    </p>
                  </Col>
                  <Col md={{ span: 4 }}>
              ...
              <section className="course-bckg">
                <Row>
                  <Col>
                    <h3 className="mt-5 mb-3">Descripcion</h3>
                    <p>{this.state.course.description}</p>

                    <h3 className="mt-5 mb-4">Lo que aprenderas:</h3>
                    ...
                    <h3 className="mt-4 mb-4">Requerimientos:</h3>
                    ...
                    {this.props.loggedUser ? (
                      ...
                      <Button
                        ...
                        className="mt-3 mb-3 start-course"
                      >
                        Conectarse para ver los medios
                      </Button>
                    )}
              ...
              <h3 className="mt-5 mb-3">Comentarios</h3>
              ...
              {this.state.comments.length > 0 ? (
                ...
                <p className="mb-3 ml-3">No cuenta con comentarios</p>
              )}
